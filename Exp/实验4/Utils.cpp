...
float* Utils::bronzeAmbient() { static float a[4] = { 0.4473f, 0.3295f, 0.1245f, 1 }; return (float*)a; }
...
float* Utils::yellowAmbient() { static float a[4] = { 0.5f, 0.5f, 0.0f, 1 }; return (float*)a; }
float* Utils::yellowDiffuse() { static float a[4] = { 0.5f, 0.5f, 0.4f, 1 }; return (float*)a; }
float* Utils::yellowSpecular() { static float a[4] = { 0.2f, 0.2f, 0.04f, 1 }; return (float*)a; }
float Utils::yellowShininess() { return 20.81f; }

// PEARL material - ambient, diffuse, specular, and shininess
float* Utils::pearlAmbient() { static float a[4] = { 0.250000f, 0.207250f, 0.207250f, 0.922000, }; return (float*)a; }
float* Utils::pearlDiffuse() { static float a[4] = { 1.000000f, 0.829000f, 0.829000f, 0.922000 }; return (float*)a; }
float* Utils::pearlSpecular() { static float a[4] = { 0.296648f, 0.296648f, 0.296648f, 0.422000 }; return (float*)a; }
float Utils::pearlShininess() { return 11.264f; }

// PEARL JADE - ambient, diffuse, specular, and shininess
float* Utils::jadeAmbient() { static float a[4] = { 0.135, 0.2225, 0.1575, 0.95 }; return (float*)a; }
float* Utils::jadeDiffuse() { static float a[4] = { 0.54, 0.89, 0.63, 0.95 }; return (float*)a; }
float* Utils::jadeSpecular() { static float a[4] = { 0.316228, 0.316228, 0.316228, 0.95 }; return (float*)a; }
float Utils::jadeShininess() { return 12.8f; }

// PEARL RUBY - ambient, diffuse, specular, and shininess
float* Utils::rubyAmbient() { static float a[4] = { 0.1745, 0.01175, 0.01175, 0.55 }; return (float*)a; }
float* Utils::rubyDiffuse() { static float a[4] = { 0.61424, 0.04136, 0.04136, 0.55 }; return (float*)a; }
float* Utils::rubySpecular() { static float a[4] = { 0.727811, 0.626959, 0.626959,0.55 }; return (float*)a; }
float Utils::rubyShininess() { return 46.8f; }

// PEARL EMERALD - ambient, diffuse, specular, and shininess
float* Utils::emeraldAmbient() { static float a[4] = { 0.0215, 0.1745, 0.0215, 0.55 }; return (float*)a; }
float* Utils::emeraldDiffuse() { static float a[4] = { 0.07568, 0.61424, 0.07568, 0.55 }; return (float*)a; }
float* Utils::emeraldSpecular() { static float a[4] = { 0.633, 0.727811, 0.633, 0.55 }; return (float*)a; }
float Utils::emeraldShininess() { return 76.8; }

//  ambient, diffuse, specular, and shininess
float* Utils::regularAmbient() { static float a[4] = { 0.7, 0.7,0.7, 1 }; return (float*)a; }
float* Utils::regularDiffuse() { static float a[4] = { 0.1, 0.1, 0.1, 1 }; return (float*)a; }
float* Utils::regularSpecular() { static float a[4] = { 0.1, 0.1, 0.1, 1 }; return (float*)a; }
float Utils::regularShininess() { return 20; }